...
1. [Appendix](#appendix)
1. [Cato Tip Address](#cato-tip-address)
...
- [CatoCoin Wallet](https://github.com/CatoCoin/releases) ([Windows](https://github.com/CatoCoin/releases/raw/master/catocoin-qt.zip), [Mac](https://github.com/CatoCoin/releases/raw/master/CATO-Qt.dmg), [Linux](https://github.com/CatoCoin/releases/raw/master/catocoin-linux-binaries.tar.gz))
...
You can also run `startmasternode alias false mymnalias` in the desktop console to start the masternode; replace the ending alias with the name of the masternode like this `startmasternode alias false cato_mn2_vultr.guest`. Get the list of aliases by running `masternode list-conf`.
...
# Cato Tip Address #
CbExC5RLwSghSNEq8pwDtiTS32Ngr8qquw
